...
var HI: Height = Height(heightInInches: 65)
print(HI.heightInCentimeters)
var HC: Height = Height(heightInCentimeters: 165.1)
print(HC.heightInInches)
...
var myHeight: Height = Height(heightInInches: 72)
