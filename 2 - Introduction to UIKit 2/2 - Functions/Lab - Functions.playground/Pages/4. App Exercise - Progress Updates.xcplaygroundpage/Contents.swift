...
func pacing(currentDistance: Double, totalDistance: Double, currentTime: Double, goalTime: Double) {
    let timePerMile = currentTime / currentDistance
    let timeToBeatGoal = goalTime / totalDistance
    if timePerMile <= timeToBeatGoal {
        print("Keep it up!")
    } else {
        print("You've got to push it just a bit harder!")
    }
}
pacing(currentDistance: 3, totalDistance: 10, currentTime: 3.30, goalTime: 5.40)
/*:
