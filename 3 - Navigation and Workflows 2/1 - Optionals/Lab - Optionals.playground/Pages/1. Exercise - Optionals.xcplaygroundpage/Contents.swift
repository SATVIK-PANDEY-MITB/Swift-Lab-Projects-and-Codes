...
print(userAge1)  // Prints: nil
print("userAge1 is nil because \"34e\" is not a valid integer string.")
...
print(userAge2)  // Prints: Optional(34)
print("userAge2 prints as Optional(34) because it's an optional Int.")
